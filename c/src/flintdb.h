...
enum flintdb_null_spec { SPEC_NULLABLE = 0, SPEC_NOT_NULL = 1 };
...
// Main aggregate API
FLINTDB_API struct flintdb_aggregate *aggregate_new(const char *id, struct flintdb_aggregate_groupby **groupby, u16 groupby_count, struct flintdb_aggregate_func **funcs, u16 func_count, char **e);
