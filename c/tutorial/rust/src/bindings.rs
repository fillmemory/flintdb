...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of flintdb_transaction"][::std::mem::size_of::<flintdb_transaction>() - 64usize];
    ...
    ["Offset of field: flintdb_transaction::close"]
        [::std::mem::offset_of!(flintdb_transaction, close) - 48usize];
    ["Offset of field: flintdb_transaction::priv_"]
        [::std::mem::offset_of!(flintdb_transaction, priv_) - 56usize];
};
unsafe extern "C" {
