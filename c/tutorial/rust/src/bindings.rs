...
const _: () = {
    ...
    ["Offset of field: flintdb_decimal::raw"]
        [::std::mem::offset_of!(flintdb_decimal, raw) - 2usize];
    ["Offset of field: flintdb_decimal::reserved"]
        [::std::mem::offset_of!(flintdb_decimal, reserved) - 3usize];
...
unsafe extern "C" {
    pub fn flintdb_meta_new_ptr(
        name: *const ::std::os::raw::c_char,
        e: *mut *mut ::std::os::raw::c_char,
    ) -> *mut flintdb_meta;
}
unsafe extern "C" {
    pub fn flintdb_meta_open_ptr(
        filename: *const ::std::os::raw::c_char,
        e: *mut *mut ::std::os::raw::c_char,
    ) -> *mut flintdb_meta;
}
unsafe extern "C" {
    pub fn flintdb_meta_free_ptr(m: *mut flintdb_meta);
}
unsafe extern "C" {
